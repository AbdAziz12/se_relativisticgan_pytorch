...
class Generator(nn.Module):
    ...
    def __init__(self, input_channels=1, output_channels=1, base_filters=16):
        ...
        # Encoder
        self.enc1 = self._conv_block(input_channels, base_filters, kernel_size=15, stride=2)
        self.enc2 = self._conv_block(base_filters, base_filters * 2, kernel_size=15, stride=2)
...
class Discriminator(nn.Module):
    ...
    def __init__(self, input_channels=2, base_filters=16):
        ...
        self.conv1 = self._conv_block(input_channels, base_filters, kernel_size=15, stride=2)
        self.conv2 = self._conv_block(base_filters, base_filters * 2, kernel_size=15, stride=2)
